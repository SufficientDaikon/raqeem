...
- **تطابق المعالجة، بالكلام الصريح.** `normalize_ar` دالة واحدة متكتوبة بلغتين، ولحد 0.3.0 كان كل
  ...
  إننا عدّينا كل الحروف المحتملة على الاتنين وقارنّا — 6912 حالة على ASCII و Latin-1 وبلوكات
  العربي و General Punctuation و الـ Presentation Forms بنوعيها. المسح ده هو اللي لقى الـ bug،
  وبق تاني محدش كان بيدوّر عليه. بص على
...
لو هتبني من الـ source، محتاج Rust 1.82 أو أحدث.
